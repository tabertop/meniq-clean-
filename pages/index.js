    ...
    <>
      <Head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "name": "MenIQ Men's Health Assessment", "url": "https://meniq.co",
          "description": "Free 30-second men's health quiz with personalized results.",
          "applicationCategory": "HealthApplication", "isAccessibleForFree": true,
          "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD" },
          "provider": { "@type": "Organization", "name": "MenIQ.co", "url": "https://meniq.co" },
          "featureList": ["ED assessment","Hair loss risk score","Testosterone screening","Personalized health profile"]
        })}} />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "How long does the test take?", "acceptedAnswer": { "@type": "Answer", "text": "About 30 seconds. Answer 6 questions and get instant results." } },
            { "@type": "Question", "name": "What does MenIQ test for?", "acceptedAnswer": { "@type": "Answer", "text": "ED, hair loss, testosterone levels, and relationship health." } }
          ]
        })}} />
        {/* Google Analytics GA4 */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-JNQFDH8R29" />
