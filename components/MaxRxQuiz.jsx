...
const QUIZZES = {
  ed: {
    ...
    questions: [
      ...
      {
        id: "stress",
        text: "Have things felt consistent… or more up and down lately?",
        options: [
          { label: "All over the place", value: 3 },
          { label: "Up and down", value: 2 },
      ...
      {
        id: "morning",
        text: "How often do you wake up feeling ready?",
        options: [
          { label: "Almost never", value: 3 },
          { label: "Rarely", value: 2 },
          { label: "Sometimes", value: 1 },
          { label: "Consistently", value: 0 },
        ],
      },
      {
        id: "treatment",
    ...
    <div className="mrx-progress">
      ...
      {earlyExit && (
        <div style={{
          ...
          justifyContent:'center', zIndex:9999, gap:'16px', padding:'32px',
        }}>
...
export default function MaxRxQuiz() {
  ...
  const earlyExitFired = useRef(false);
  function handleEarlyExit() {
    if (earlyExitFired.current) return;
    earlyExitFired.current = true;
